...
const f = 'src/features/admin/export/screens/DataExportScreen.tsx';
...
function visit(node) {
  ...
  if (expr) {
    ...
    if (ts.isIdentifier(root) && root.text === importName) {
      ...
      console.log('Found', chain.join('.'), 'hasColorProp:', hasColorProp, 'insideFunction:', isInsideFunction(node));
    }
  }
