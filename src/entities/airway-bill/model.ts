/**
 * Airway Bill Entity Model
 * Core domain types for the Airway Bill entity
 */
...
export type AirwayBillWaypointType =
  | "AIRPORT"
  | "CUSTOMS"
  | "WAREHOUSE"
  | "CONTAINER";

export type AirwayBillWaypointSegmentType =
  | "AIR"
  | "CUSTOMS"
  | "WAREHOUSE"
  | "ROAD"
