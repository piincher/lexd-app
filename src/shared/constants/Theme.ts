...
export const lightTheme = {
  ...
  gradients: {
    ...
    cyan: ['#06B6D4', '#0891B2', '#0E7490'] as const,
...
export const darkTheme = {
  colors: {
    ...
    // Neutral Colors (Gray Scale) - Dark Mode (inverted scale)
    neutral: {
      white: '#FFFFFF',
      50: '#111827',
      100: '#1F2937',
  ...
  gradients: {
    ...
    purple: ['#7C3AED', '#8B5CF6', '#A78BFA'] as const,
    pink: ['#BE185D', '#DB2777', '#F472B6'] as const,
    cyan: ['#0E7490', '#0891B2', '#22D3EE'] as const,
