...
import { styles } from './RouteStopsManager.styles';
  ...
  if (stops.length === 0) {
    return (
      <View style={styles.emptyState}>
        <Ionicons name="location-outline" size={48} color={Theme.neutral[300]} />
          ...
          <Card key={`${stop}-${index}`} variant="outlined" padding="small" style={styles.stopCard}>
            <View style={styles.stopRow}>
              <View style={styles.stopInfo}>
                ...
                <Ionicons name="location" size={20} color={Theme.primary.main} />
