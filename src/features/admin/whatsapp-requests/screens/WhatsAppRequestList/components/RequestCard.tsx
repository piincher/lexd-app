...
import { TYPE_LABELS, STATUS_LABELS } from '@src/features/admin/whatsapp-requests/screens/WhatsAppRequestList/constants';
...
export const RequestCard: React.FC<RequestCardProps> = ({
  ...
  const statusColor =
    ...
    request.status === 'PROCESSING' ? '#3B82F6' :
    request.status === 'COMPLETED' ? '#10B981' :
    request.status === 'FAILED' ? '#EF4444' : Theme.neutral[400];
          ...
          <View style={styles.searchResults}>
            <View style={styles.resultItem}>
              ...
              <Text style={styles.resultText}>
                {request.searchResults.goodsFound.length} marchandise(s)
              </Text>
            </View>
            <View style={styles.resultItem}>
