...
import { RowDetails } from "@src/features/home";
import { useViewSmsBalance } from "@src/features/home";
...
const list: dataType = [
   // V2 Features - Goods & Container Management
   {
      id: "v2-0",
   ...
   {
      id: "v2-1",
      title: "📋 Liste Marchandises",
      route: "AdminGoodsList",
   },
   {
      id: "v2-2",
      title: "👥 Gestion Consignés",
      route: "ConsigneeList",
   },
   {
      id: "v2-3",
