...
export const getStyles = (colors: any) =>
  StyleSheet.create({
    ...
    retryButton: { marginTop: 8, paddingHorizontal: 16, paddingVertical: 8, backgroundColor: hexToRgba(colors.accent.gold, 0.15), borderRadius: 8, borderWidth: 1, borderColor: hexToRgba(colors.accent.gold, 0.3) },
