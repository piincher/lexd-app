...
const Profile = ({ navigation }: HomeTabScreenProps<"Profile">) => {
   ...
   const animateHeader = (index: number) => ({
   ...
   const listItemAnimation = (index: number) => ({
         ...
         <LinearGradient colors={["#1a237e", "#4a148c", "#880e4f"]} style={StyleSheet.absoluteFill}>
            ...
            <BlurView intensity={30} style={StyleSheet.absoluteFill}>
               ...
               <List.Section style={styles.section}>
                  <MotiView {...listItemAnimation(0)}>
                     <View style={[styles.listItem, { paddingHorizontal: 16, paddingVertical: 4 }]}>
                  ...
                  {[
                     ...
                     <MotiView key={item.title} {...listItemAnimation(index + 1)}>
                        <AnimatedList
                           title={item.title}
                           ...
                           entering={FadeIn.delay(500 + (index + 1) * 100)}
                           exiting={FadeOut}
                        />
                     </MotiView>
                  ))}
