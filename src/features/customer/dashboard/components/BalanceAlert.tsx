...
export const BalanceAlert: React.FC<BalanceAlertProps> = ({
  balanceDue,
  onPress,
}) => {
  ...
  return (
    ...
    >
      ...
      <View style={styles.content}>
        <Text style={[styles.title, { color: Theme.status.error }]}>
          Paiement Requis
        </Text>
        <Text style={[styles.text, { color: theme.colors.onSurfaceVariant }]}>
          Vous avez {formatCurrency(balanceDue)} à payer. Cliquez pour régler.
        </Text>
      </View>
      <MaterialCommunityIcons
        name="chevron-right"
