  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} refreshControl={<RefreshControl refreshing={isFetching} onRefresh={handleRefresh} />}>
        <PackingListSummary containerNumber={packingList.containerNumber} shippingMode={packingList.shippingMode} status={packingList.tracking.status} totalCBM={packingList.summary.totalCBM} totalWeight={packingList.summary.totalWeight} totalPackages={packingList.summary.totalItems} departureDate={packingList.route.departureDate} arrivalDate={packingList.tracking.estimatedArrival} getShippingModeIcon={getShippingModeIcon} getStatusColor={getStatusColor} formatDate={formatDate} />
        <PackingListConsignee consignee={packingList.consignee} onContactPress={() => setContactDialogVisible(true)} onAddressPress={handleOpenMaps} />
