...
import { ContainerWaypoint, WaypointStatus, WAYPOINT_STATUS_LABELS, WAYPOINT_TYPE_ICONS, WAYPOINT_TYPE_LABELS, TRANSPORT_MODE_ICONS, TRANSPORT_MODE_LABELS, CUSTOMER_WAYPOINT_TYPE_COLORS } from '../types';
...
// Local adapter mapping customer waypoint statuses to shared color palette
...
export const TimelineWaypointCard: React.FC<WaypointCardProps> = ({
  waypoint,
  isCurrent = false,
  isCompleted = false,
}) => {
    ...
    >
      ...
      <View style={styles.leftSection}>
        <View
          style={[
            ...
            { backgroundColor: `${typeColor}${isDark ? '35' : '15'}` },
          ]}
        >
      ...
      <View style={styles.content}>
        ...
        <View
          style={[
            styles.statusBadge,
            { backgroundColor: `${statusColor}${isDark ? '28' : '12'}` },
          ]}
        >
          <View
            style={[
