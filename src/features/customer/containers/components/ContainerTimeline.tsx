...
import { createTimelineStyles } from "./ContainerTimeline/ContainerTimeline.styles";
import { TimelineStep } from "./ContainerTimeline/TimelineStep";
import { useTimelineLogic } from "./ContainerTimeline/useTimelineLogic";
...
export const ContainerTimeline: React.FC<ContainerTimelineProps> = ({
  ...
  const { isStepCompleted, isCurrentStep, formatDate, getStepIcon, getProgressWidth } =
    useTimelineLogic(currentStatus);
      ...
      <View style={styles.progressBarContainer}>
        ...
        <View
          style={[
            ...
            { width: getProgressWidth(currentStatus), backgroundColor: primaryColor },
          ]}
        />
      </View>
