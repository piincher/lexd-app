...
export const styles = StyleSheet.create({
  ...
  routeFlowTitle: { fontSize: 15, fontWeight: '700', color: '#0369A1', marginLeft: Theme.spacing.sm },
  ...
  routeFlowText: { fontSize: 11, fontWeight: '600', color: Theme.neutral[700] },
  routeFlowTextHighlight: { color: '#059669', fontSize: 13, fontWeight: '700' },
  routeFlowSubtext: { fontSize: 9, color: Theme.neutral[500] },
  ...
  mainPortTagText: { fontSize: 7, fontWeight: '800', color: '#FFF' },
  ...
  // Summary
  summaryCard: { backgroundColor: Theme.neutral.white, ...cardBase, marginTop: Theme.spacing.lg, padding: Theme.spacing.lg, ...Theme.shadows.sm },
  summaryTitle: { fontSize: 14, fontWeight: '700', color: Theme.neutral[600], marginBottom: Theme.spacing.md, textTransform: 'uppercase' },
  summaryRow: { ...flexRow, justifyContent: 'space-between' },
  summaryItem: { alignItems: 'center', flex: 1 },
  summaryLabel: { fontSize: 11, color: Theme.neutral[500], marginTop: Theme.spacing.xs },
  summaryValue: { fontSize: 14, fontWeight: '700', color: Theme.neutral[800], marginTop: 2 },
  ...
  arrivalIconContainer: { width: 56, height: 56, borderRadius: 28, backgroundColor: '#FFF', justifyContent: 'center', alignItems: 'center' },
  arrivalContent: { flex: 1 },
  arrivalLabel: { fontSize: 12, color: COLORS.orange, fontWeight: '600', textTransform: 'uppercase' },
  arrivalValue: { fontSize: 18, fontWeight: '800', color: COLORS.DarkGrey },
  arrivalDestination: { fontSize: 13, color: Theme.neutral[500], marginTop: 2 },
  ...
  dakarInfoText: { fontSize: 13, color: Theme.neutral[700] },
  dakarInfoHighlight: { fontWeight: '700', color: '#059669' },
  dakarInfoETA: { fontSize: 12, color: Theme.neutral[600], marginTop: Theme.spacing.sm, fontStyle: 'italic' },
  ...
  pickupTitle: { fontSize: 14, fontWeight: '800', color: '#FFF', marginLeft: Theme.spacing.sm },
  warehouseName: { fontSize: 18, fontWeight: '800', color: '#FFF' },
  divider: { backgroundColor: 'rgba(255,255,255,0.3)', marginVertical: Theme.spacing.md },
  phoneButton: { ...flexRow, backgroundColor: '#FFF', paddingHorizontal: Theme.spacing.md, paddingVertical: Theme.spacing.sm, borderRadius: Theme.radius.lg, alignSelf: 'flex-start', gap: Theme.spacing.sm },
