...
export const createStyles = (colors: any, isDark: boolean) => StyleSheet.create({
  ...
  progressBackground: { height: 8, backgroundColor: 'rgba(255,255,255,0.3)', borderRadius: Theme.radius.full, overflow: 'hidden' },
  progressFill: { height: '100%', backgroundColor: colors.background.card, borderRadius: Theme.radius.full },
  progressText: { fontSize: 12, color: 'rgba(255,255,255,0.9)', marginTop: Theme.spacing.sm, fontWeight: '600' },
  ...
  warehouseAddress: { fontSize: 14, color: 'rgba(255,255,255,0.8)', marginTop: 2 },
  divider: { backgroundColor: 'rgba(255,255,255,0.3)', marginVertical: Theme.spacing.md },
  consigneeSection: { marginTop: Theme.spacing.sm },
  consigneeLabel: { fontSize: 13, color: 'rgba(255,255,255,0.8)', marginBottom: 4 },
  ...
  hours: { fontSize: 13, color: 'rgba(255,255,255,0.9)' },
  addressRow: { ...flexRow, alignItems: 'flex-start', gap: Theme.spacing.sm },
  addressText: { fontSize: 12, color: 'rgba(255,255,255,0.8)', flex: 1 },
});
