...
import { ImageBackground, Keyboard, StyleSheet, TextInput, View } from 'react-native';
...
const Verification = ({ route, navigation }: RootStackScreenProps<'Verification'>) => {
	...
	return (
		<AuthFormContainer title='Verification' subTitle='Entre le code de verification '>
			...
			<View>
				{/* Show the icons from expo vector  of three social media, facebook ,instagram and tik tok they should be space between them also it should be all the way down of the screen */}
