import { FlatList, StyleSheet, Text, View, Animated, Dimensions, Image, TouchableOpacity } from 'react-native';
...
const DATA = [
	{
		...
		description: "Nous vous aidons à envoyer des colis à vos proches en Afrique de l'ouest(Mali)!",
		image: IMAGES.onboarding2,
	},
	{
		key: '3571747',
		title: 'Suivez vos colis en temps réel',
		description: 'Nous vous permettons de suivre vos colis en temps réel et de savoir où ils se trouvent!',
		image: IMAGES.onboarding1,
	},
	{
		key: '3571680',
		title: "Soyez informé de l'état de vos colis en temps réel",
		description: "Nous vous informons de l'état de vos colis en temps réel et vous notifions de chaque étape!",
		image: IMAGES.onboarding3,
	},
	{
		key: '3571603',
		title: 'Recuperez vos colis en toute sécurité',
		description: 'Nous vous permettons de récupérer vos colis en toute sécurité et en toute confiance!',
					...
					return (
						<View style={{ width, alignItems: 'center', padding: 20 }}>
							...
							<View style={{ flex: 0.3 }}>
								...
								<Text style={{ color: COLORS.white, fontFamily: Fonts.boldItalic }}>{item.description}</Text>
							</View>
						</View>
					);
				}}
